...
def base_train_ULDPFS(iterate, dist_idx, epsilon, n, d, m):
    ...
    param_dict = {"epsilon": [epsilon],
              ...
              "regressor_params": [{"num_bins" : 2**2}, {"num_bins" : 2**3}, {"num_bins" : 2**4}]}
    ...
    for param_values in product(*param_dict.values()):
        ...
        with open(log_file_path, "a") as f:
            ...
            logs= "{},{},{},{},{},{},{},{:4f},{:4f},{:4f},{:4f},{:4f},{:4f},{},{:4f}\n".format(
                                                                        ...
                                                                        l1_error,
                                                                        mse,
                                                                        "{}:{}".format(params["selector"], params["regressor_params"]),
                                                                        time_used,
                                                                        )
...
def base_train_ULDPFS_IA(iterate, dist_idx, epsilon, n, d, m):
    ...
    # ULDPFS_IA
    method = "ULDPFS_IA"
    regressor_params = {"num_bins": [2**3], "B":[3], "batch_size":[40], "lr_const":[0.1], "lr_power": [ 0.2]}
